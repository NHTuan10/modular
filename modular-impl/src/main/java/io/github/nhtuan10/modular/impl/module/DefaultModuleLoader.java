...
//            case JACKSON_SMILE -> new JacksonSmileSerDeserializer();
    ...
    private void loadModuleFromUrls(String moduleName, ModuleLoadConfiguration moduleLoadConfiguration, List<URL> depUrls) {
        ModularClassLoader moduleClassLoader = moduleLoadConfiguration.modularClassLoader() != null ?
                moduleLoadConfiguration.modularClassLoader() : new DefaultModularClassLoader(moduleName, depUrls);
