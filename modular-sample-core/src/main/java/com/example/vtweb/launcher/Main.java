...
public class Main {
    public static void main(String[] args) {
        Modular.startModuleSync("modular-sample-plugin", List.of("mvn://io.github.nhtuan10/modular-sample-plugin/0.0.1"), List.of("io.github.nhtuan10.sample.service","io.github.nhtuan10.sample.util"));
